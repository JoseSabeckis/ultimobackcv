...
public class experiencia {
	...
	public experiencia(@NotNull @Size(min = 1, max = 50, message = "no cumple la longitud") String titulo,
			@NotNull @Size(min = 1, max = 50, message = "no cumple la longitud") String years,
			@NotNull @Size(min = 1, max = 50, message = "no cumple la longitud") String descripcion) {
		this.titulo = titulo;
		this.years = years;
